(function() {
  var ActionPresentable, AutoResponse, Component, ContainerDrawable, Drawable, GraphicalStimulus, KineticDrawable, KineticStimulus, Presentable, Q, Reaction, Response, ResponseArray, ResponseData, Stimulus, lay, match, signals, _,
  ...
  exports.Stimulus = Stimulus = (function(_super) {
    ...
    Stimulus.prototype.initReactions = function() {
      ...
      console.log("initializing reactions from " + this.constructor.name, this.react);
      _ref = this.react;
      _results = [];
      for (key in _ref) {
        value = _ref[key];
