(function() {
  ...
  exports.Stimulus = Stimulus = (function(_super) {
    ...
    Stimulus.prototype.computeCoordinates = function(context, position, nodeWidth, nodeHeight) {
      ...
      xy = position ? this.layout.computePosition([context.width(), context.height()], position) : this.spec.x && this.spec.y ? [this.layout.convertToCoordinate(this.spec.x, context.width()), this.layout.convertToCoordinate(this.spec.y, context.height())] : [0, 0];
      if (this.spec.origin != null) {
        console.log("spec origin", this.spec.origin);
...
/*
//# sourceMappingURL=../lib/canvas/stimresp.js.map
*/