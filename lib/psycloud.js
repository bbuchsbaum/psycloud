(function() {
  var Background, Bacon, Block, BlockSeq, DataTable, DefaultComponentFactory, Event, EventData, EventDataLog, Experiment, ExperimentContext, ExperimentState, Kinetic, KineticContext, MockStimFactory, Prelude, Presenter, Q, Response, RunnableNode, StimFactory, Stimulus, TAFFY, Trial, buildEvent, buildPrelude, buildResponse, buildStimulus, buildTrial, createContext, des, utils, _, _ref,
    ...
    Trial.prototype.after = function(context, callback) {
      ...
      return function() {
        ...
        if (_this.feedback != null) {
          ...
          spec = _this.feedback.apply(args);
  ...
  */
  ...
  exports.Presenter = Presenter = (function() {
    function Presenter(trialList, display, context) {
      ...
      this.prelude = this.display.Prelude != null ? buildPrelude(this.display.Prelude.Events, this.context) : new Prelude([]);
    }
        ...
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          ...
          trials = (function() {
            ...
            for (trialNum = _j = 0, _ref2 = block.length; 0 <= _ref2 ? _j < _ref2 : _j > _ref2; trialNum = 0 <= _ref2 ? ++_j : --_j) {
              ...
              trialSpec = this.trialBuilder.apply(record);
...
/*
//# sourceMappingURL=../lib/canvas/psycloud.js.map
*/