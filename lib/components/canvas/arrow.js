(function() {
  var Arrow, Kinetic, Stimulus, _ref,
  ...
  Arrow = (function(_super) {
    ...
    Arrow.prototype.render = function(context, layer) {
      var coords, group, rect, triangle, _this;
      ...
      group.add(rect);
      group.add(triangle);
      coords = this.computeCoordinates(context, this.spec.position, group.getWidth(), group.getHeight());
      group.setPosition({
        x: coords[0],
        y: coords[1]
      });
...
/*
//# sourceMappingURL=../../../lib/canvas/arrow.js.map
*/